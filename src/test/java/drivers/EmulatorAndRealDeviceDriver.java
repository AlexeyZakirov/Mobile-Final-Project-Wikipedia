...
import config.EmulatorRealDeviceConfig;
...
public class EmulatorAndRealDeviceDriver implements WebDriverProvider {

    private final EmulatorRealDeviceConfig config;

    public EmulatorAndRealDeviceDriver() {
        this.config = ConfigReader.INSTANCE.readEmulatorRealDeviceConfig();
    }
